...
namespace Apollo.Bp.Net.Card.Data.Migrations
{
    ...
    [Migration("20220701145308_PinAndStateUpdateAtFields")]
    partial class PinAndStateUpdateAtFields
    {
            ...
            modelBuilder.Entity("Apollo.Bp.Net.Card.Core.Entities.Card", b =>
                {
                    ...
                    b.Property<DateTime?>("PinUpdateAt")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("pin_update_at");
                    ...
                    b.Property<DateTime?>("StateUpdateAt")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("state_update_at");
